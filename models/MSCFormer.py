...
class ClassificationHead(nn.Sequential):
    def __init__(self, flatten_number, n_classes):
        super().__init__()
        self.fc = nn.Sequential(nn.Dropout(0.25), nn.Linear(flatten_number, n_classes))
...
class MSCFormer(nn.Module):
    def __init__(self, parameters, class_num, chn, **kwargs):
        super().__init__()
        ...
        self.trans = TransformerEncoder(
            parameters.heads, parameters.depth, parameters.emb_size
        )
